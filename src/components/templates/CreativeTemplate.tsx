...
export default function CreativeTemplate({ personalInfo, skills, projects, customStyles }: CreativeTemplateProps) {
  return (
    <div 
      className="max-w-5xl mx-auto bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50"
      style={{ fontFamily: customStyles?.font || 'Inter, sans-serif' }}
    >
      {/* Creative Header */}
